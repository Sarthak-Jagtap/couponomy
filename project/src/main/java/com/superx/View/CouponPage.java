...
public class CouponPage {
    ...
    private String selectedExpiryFilter = "All";
    private String selectedCouponType = "All";
    private int maxCoinValue = Integer.MAX_VALUE;
    private int absoluteMaxCoins = 1000;
